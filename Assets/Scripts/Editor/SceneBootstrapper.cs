...
namespace Unity.BossRoom.Editor
{
    ...
    public class SceneBootstrapper
    {
        ...
        const string k_LoadBootstrapSceneOnPlay = "2DMultiplayerVampireSurvivors/Load Bootstrap Scene On Play";
        const string k_DoNotLoadBootstrapSceneOnPlay = "2DMultiplayerVampireSurvivors/Don't Load Bootstrap Scene On Play";
